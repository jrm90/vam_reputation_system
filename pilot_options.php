...
<div class="panel panel-default">
	...
	<div class="panel-body">
		...
		<div class="row">
			...
			<div class="col-sm-4 col-sm-4">
				<div class="thumbnail">
					<a href="#!" data-toggle="modal" data-target="#JumpModal2"><img src="images/holidays.png" width="128" height="128"></a>
					<div class="caption">
						<p class="text-center"><strong><?php echo HOLIDAYS; ?></strong></p>
					</div>
				</div>
			</div>
		</div>
...
<!--Holidays modal-->
<div class="modal fade" id="JumpModal2" tabindex="-1" role="dialog" aria-labelledby="JumpModalTitle" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			<div class="modal-header">
				<button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
				<h1 class="modal-title" id="loginModalTitle"><?php echo HOLIDAYS; ?></h1>
			</div>
			<div class="modal-body">
					<form id="holidays-form" action="./index.php?page=holiday_insert" role="form" method="post">
						<label for="init_date"><?php echo INIT_DATE; ?></label>
						<input type="date" name="init_date" id="init_date">
						<label for="init_date"><?php echo FIN_DATE; ?></label>
						<input type="date" name="final_date" id="final_date">
						<button type="submit" class="btn btn-primary"><?php echo SOLIC_HOLIDAYS; ?></button>
					</form>
			</div>
			<div class="modal-footer">
				<button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
