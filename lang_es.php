<?php
	/* Footer */
	define('POLICY', 'Politica');
	/* Extra */
	define('HUB_INFO', 'Información');
	// Containers
	define('LIVE_MAP', 'Mapa en Vivo');
	// NavBar options
	define('SIGN_OUT', 'Salir');
	define('PROFILE', 'Perfil');
	define('LOGIN', 'Acceder');
	define ('HOME', 'Inicio');
	define ('ABOUT' , 'Sobre ');
	...
	define ('REGISTER_SUCCESSFUL_MSG' , 'Hemos recibido su solicitud de ingreso, procederemos a la validación en un plazo entre 1 y 7 días.
Recibirá un email una vez finalizada la validación. (Asegurese de poder recibir emails de admin@clickair-va.com - si no recibe un correo, por favor revise la carpeta de SPAM en su correo.)');
	...
	define ('PILOT_STATICS' , 'Estadísticas');
	...
	// VAM 2.6
	define ('NEW_MAIL' , 'Tienes nuevos mensajes, revisa el buzón de mensajes');
	...
	define ('RPT_PLANE_OUT_ROUTE' , 'REPORTE AERONAVES FUERA DE RUTA');
	define ('LAST_REGULAR_FLIGHT' , 'Último vuelo regular');
	define ('MOVE_TO_HUB' , 'Mover al HUB');
	define ('AIRCRAFT_HANGAR' , 'HISTORICO DE MANTENIMIENTOS DE AERONAVE ');
	define ('HANGAR_IN' , 'Fecha entrada en hangar');
	define ('HANGAR_OUT' , 'Fecha salida de hangar');
	define ('LAST_PILOT' , 'Último piloto');
	define ('REASON' , 'Razón');
	define ('NOT_GRANTED' , 'No tiene acceso a esta página');
	define ('TOUR_DESCRIPTION' , 'Descripción del tour');
	define ('RPT_PILOT_WARNING' , 'Fecha de aviso');
	define ('RPT_PLANE_OUT' , 'Reporte de Aeronaves');
	define ('RPT_PILOT_ACTIVITY' , 'Reporte Pilotos');
	define ('RPT_PILOT_ACT' , 'REPORTE ACTIVIDAD PILOTOS');
	define ('SEND_WARNING' , 'Enviar Aviso');
	define ('INACTIVATE' , 'Inactivar');
	define ('TAB_MAIN' , 'Ficha Piloto');
	define ('TAB_STATS' , 'Estadísticas Piloto');
	define ('TAB_AWARDS' , 'Medallas Piloto');
	define ('TAB_TOURS' , 'Tours Piloto');
	define ('TAB_CERTIFICATIONS' , 'Certificaciones Piloto');
	define ('PILOT_STATS_COUNTRY' , 'PORCENTAJE POR PAIS');
	define ('PILOT_STATS_PERC_PLANE' , 'PORCENTAJE POR TIPO DE AERONAVE');
	define ('PILOT_STATS_PERC_DURATION' , 'PORCENTAJE POR DURACIÓN DE VUELO');
	define ('STATISTICS_NUMBER_FLIGTH_PER_MONTH_CURRENT_YEAR' , 'NUMERO DE VUELOS POR MES EN AÑO ACTUAL');
	define ('AVG_DURATION' , 'Duración média de vuelo');
	define ('AVG_DISTANCE' , 'Distancia média de vuelo');
	define ('AVG_LANDING_VS' , 'Media de V/S en aterrizaje');
	define ('LAST_30D_FLIGHT' , 'Vuelos últimos 30 días');

//Modificaciones Clickair VA by JRM
	define ('FAQ' , 'Preguntas Frecuentes');
	define ('REGISTER_TEST','Test de registro');
	//For JRM Modifications SimBrief Integration
	define ('LAST_NEWS' , 'Últimas noticias');
	define ('GUIDES' , 'Guías');
	define ('CREATE_SB' , 'Crear ruta con SimBrief');
	define ('CREATING_SB' , 'Creando ruta con SimBrief');
	define ('DF_DATA' , 'Datos por defecto');
	define ('AIRLINE_CODE' , 'Código aerolinea');
	define ('FLT_NUM' , 'Número de vuelo');
	define ('CI' , 'Cost Index');
	define ('FP_FORMAT' , 'Formato de plan de vuelo');
	define ('UNIT_FUEL' , 'Unidades de combustible');
	define ('MD_DATA' , 'Datos obligatorios');
	define ('ORIG' , 'Origen');
	define ('DEST' , 'Destino');
	define ('ARCF_TYPE' , 'Tipo de aeronave');
	define ('EX_DATA' , 'Datos adicionales');
	define ('H_DEP' , 'Hora de salida');
	define ('M_DEP' , 'Minutos de salida');
	define ('FL' , 'Nivel de vuelo');
	define ('COMMS' , 'Commentarios');
	define ('ROUTE' , 'Ruta');

	define ('RQ_RR' , 'Solicitar como Ruta Regular');
	define ('NEW_SB_ROUTE' , 'Nueva ruta con SimBrief');
	define ('SA_DATA' , 'Datos SIM ACARS');
	define ('FUEL' , 'Combustible');
	define ('CP_OFP' , 'Flight Plan completo');
	define ('M_STE' , 'Minutos de llegada');
	define ('H_STE' , 'Hora de llegada');
	define ('COMMS_TEXT' , 'Creada con SimBrief');
	define ('ATT' , 'Atención');
	define ('REMEMBER_LOAD' , 'Recuerde cargar el combustible y el pasaje antes de conectar SIM ACARS a la web.');
	define ('FUEL_DATA_IN' , 'Datos de combustible están en ');

	define ('MOVE_ARCF' , 'Mover aeronave');
	define ('MOVE_INFO' , 'Puede mover una de las aeronaves del listado hasta su localización para realizar el vuelo solicitado.');
	define ('MOVE_INFO2' , 'Esto sólo muestra las aeronaves que han sido habilitadas para volar la ruta que está solicitando.');
	define ('MOVED_ARCF' , 'Aeronave movida');
	define ('MOVED_ARCF_INFO' , 'Aeronave movida a ');

	define ('BOOKING_ARCF_SB' , 'Reservando vuelo y generando plan de vuelo con SimBrief');
	define ('BOOKING_CHECK' , 'Revise estos datos cuidadosamente.');
	define ('BOOKING_CONFIRM_SB' , 'Reservar ruta y crear FP con SimBrief');
	define ('BOOKING_CONFIRM' , 'Reservar ruta');
	define ('BOOKING_CREATE_FOR' , 'Ruta creada para el tipo de aeronave ');
	define ('BOOKING_CREATE_RESERVED' , ' usted ha reservado un ');

	//Solicitud de rutas
	define ('CREATE_U_EX' , 'La ruta que pretende crear ya existe.');
	define ('CREATE_U_REQUESTED' , 'La ruta que pretende crear ya ha sido solicitada.');
	define ('CREATE_U_NEW' , 'Nueva solicitud de Ruta Regular.');
	define ('CREATE_U_OK' , 'La ruta ha sido solicitada correctamente.');
	define ('CREATE_U_OTHER' , 'Solicitar otra ruta');
	define ('CREATING_BACK' , 'Creando ruta de vuelta');
	define ('BACK_CREATED_OK' , 'Ruta de vuelta creada correctamente.');
	define ('BACK' , 'Atrás');
	define ('ROUTE_BACK_REQUESTED' , 'Esta ruta de vuelta ya ha sido solicitada.');
	define ('ROUTE_BACK_EX_CHECK' , 'Compruebe el listado de rutas. Si tiene algún problema contacte con el staff.');
	define ('ROUTE_BACK_EX' , 'Esta ruta de vuelta ya existe.');
	define ('ROUTE_REQ' , 'Solicitudes de rutas');
	define ('DISTANCE' , 'Distancia');
	define ('ACTIONS' , 'Acciones');
	
	define ('EDITING_ROUTE' , 'Editando ruta ');
	define ('EDIT_HAND' , 'Editar a mano');
	define ('EDIT_SB' , 'Editar con SimBrief');
	define ('SAVE_EDIT_ROUTE' , 'Guardar edición de ruta');
	define ('SAVE_EDIT_ROUTE_SB' , 'Editar ruta con SimBrief');
	define ('EDIT_TYPE_DF' , 'Por defecto se usa el B739');
	
	define ('ADDING_ROUTE_EX' , 'La ruta que pretende agregar ya existe');
	define ('ADDING_ROUTE' , 'Agregando ruta...');
	define ('ADDING_ROUTE_ERR' , 'Hubo un error agregando la ruta');
	define ('ADDING_ROUTE_INFO1' , 'Ruta desde');
	define ('ADDING_ROUTE_INFO2' , 'a');
	define ('ADDING_ROUTE_ADDED' , 'agregada.');
	define ('ADDING_ROUTE_ADDED_FT' , 'Agregadas los tipos de aeronaves');
	define ('ADDING_ROUTE_ADDED_FT_ERR' , 'Hubo un error agregando los tipos de aeronaves.');
	
	//Guias
	define('NAME_GUIDE3','Web Clickair');
    define('DESCRIPTION_GUIDE3','En ésta guía vamos a explicar cómo funciona la nueva página web de Clickair VA. y cómo usarla correctamente. Iremos viendo cada una de las páginas que componen la web y cómo navegar por ellas.');
	define('NAME_GUIDE2','Reporte de vuelos');
    define('DESCRIPTION_GUIDE2','Guía de cómo reportar vuelos y posibles problemas.');
	define('NAME_GUIDE1','SIMACARS');
    define('DESCRIPTION_GUIDE1','En ésta guía vamos a explicar cómo usar el tracker SIM ACARS con Clickair VA, cómo configurarlo y algunos aspectos de la aplicación. Además, vamos a dar algunos consejos, advertencias y trucos para no tener ningún problema con él.');
	
	define ('EDITION_RR' , 'Edición de solicitud de ruta');
	define ('EDITION_OK' , 'La solicitud de ruta se ha editado correctamente.');
	define ('EDITION_OK_SB' , 'La solicitud de ruta se ha editado correctamente con SimBrief.');

	//Sistema de reputacion
	define('REP', 'Reputación');
	define('PILOT_REP', 'Reputación del piloto');
	define('ALTER_PILOT_REP', 'Alterar reputación');
	define('ALTER_REASON', 'Razón de la alteración');
	define('HOLIDAYS', 'Vacaciones');
	define('INIT_DATE','Fecha de inicio:');
	define('FIN_DATE','Fecha de final:');
	define('SOLIC_HOLIDAYS','Solicitar vacaciones');
	define('HOLIDAYS_REQUESTS','Solicitudes de vacaciones');
	define('DAYS_OF_HOLIDAYS','Dias actuales');
