<?php
	...
	$sql = "SELECT *, date_format(register_date,'$va_date_format') as register_date FROM gvausers where gvauser_id=$id";
	...
	{
		$sql = "select sum(time) as gva_hours from v_total_data_flight_no_rejected where pilot=$id group by pilot";
	}
	else
	{
		$sql = "select sum(time) as gva_hours from v_total_data_flight where pilot=$id group by pilot";
	}
	...
	while ($row = $result->fetch_assoc()) {
		$gva_hours = $gva_hours + round($row['gva_hours'] , 2);
	}
	...
	$sql = "select count(pirep_id) numpireps from pireps where gvauser_id=$id";
	if (!$result = $db->query($sql)) {
		die('There was an error running the query [' . $db->error . ']');
	}
	while ($row = $result->fetch_assoc()) {
	...
	$sql = "select count(pirep_id) numpireps from pireps where gvauser_id=$id and charter=0";
	if (!$result = $db->query($sql)) {
		die('There was an error running the query [' . $db->error . ']');
	}
	while ($row = $result->fetch_assoc()) {
	...
	$sql = "select sum(distance) distance from pireps where gvauser_id=$id";
	if (!$result = $db->query($sql)) {
		die('There was an error running the query [' . $db->error . ']');
	}
	while ($row = $result->fetch_assoc()) {
	...
	$sql = "select count(*) flights from pirepfsfk where gvauser_id=$id";
	if (!$result = $db->query($sql)) {
		die('There was an error running the query [' . $db->error . ']');
	}
	while ($row = $result->fetch_assoc()) {
	...
	$sql = "select count(*) flights from pirepfsfk where gvauser_id=$id and charter=0";
	if (!$result = $db->query($sql)) {
		die('There was an error running the query [' . $db->error . ']');
	}
	while ($row = $result->fetch_assoc()) {
	...
	$sql = "select sum(DistanceRoute) distance from pirepfsfk where gvauser_id=$id";
	if (!$result = $db->query($sql)) {
		die('There was an error running the query [' . $db->error . ']');
	}
	while ($row = $result->fetch_assoc()) {
	...
	$sql = "select count(*) flights from reports where pilot_id=$id";
	if (!$result = $db->query($sql)) {
		die('There was an error running the query [' . $db->error . ']');
	}
	while ($row = $result->fetch_assoc()) {
	...
	$sql = "select count(*) flights from reports where pilot_id=$id and charter=0";
	if (!$result = $db->query($sql)) {
		die('There was an error running the query [' . $db->error . ']');
	}
	while ($row = $result->fetch_assoc()) {
	...
	$sql = "select count(*) flights from vampireps where gvauser_id=$id";
	if (!$result = $db->query($sql)) {
		die('There was an error running the query [' . $db->error . ']');
	}
	while ($row = $result->fetch_assoc()) {
	...
	$sql = "select sum(distance) distance from vampireps where gvauser_id=$id";
	if (!$result = $db->query($sql)) {
		die('There was an error running the query [' . $db->error . ']');
	}
	while ($row = $result->fetch_assoc()) {
	...
	$sql = "select count(*) flights from vampireps where gvauser_id=$id and charter=0";
	if (!$result = $db->query($sql)) {
		die('There was an error running the query [' . $db->error . ']');
	}
	while ($row = $result->fetch_assoc()) {
	...
	$sql = "select sum(distance) as distance from reports where pilot_id=$id";
	if (!$result = $db->query($sql)) {
		die('There was an error running the query [' . $db->error . ']');
	}
	while ($row = $result->fetch_assoc()) {
	...
	{
		//  Get count number of manual pireps for pilot's stadistics
		$sql = "select count(pirep_id) numpireps from pireps where gvauser_id=$id and valid=2";
		if (!$result = $db->query($sql)) {
			die('There was an error running the query [' . $db->error . ']');
		}
		while ($row = $result->fetch_assoc()) {
		...
		//  Get count number of regular manual pireps for pilot's stadistics
		$sql = "select count(pirep_id) numpireps from pireps where gvauser_id=$id and charter=0 and valid=2";
		if (!$result = $db->query($sql)) {
			die('There was an error running the query [' . $db->error . ']');
		}
		while ($row = $result->fetch_assoc()) {
		...
		//  Get distancer of regular manual pireps for pilot's stadistics
		$sql = "select sum(distance) distance from pireps where gvauser_id=$id and valid=2";
		if (!$result = $db->query($sql)) {
			die('There was an error running the query [' . $db->error . ']');
		}
		while ($row = $result->fetch_assoc()) {
		...
		// Get FS Keeper flights for pilot's stadistics
		$sql = "select count(*) flights from pirepfsfk where gvauser_id=$id and validated=2";
		if (!$result = $db->query($sql)) {
			die('There was an error running the query [' . $db->error . ']');
		}
		while ($row = $result->fetch_assoc()) {
		...
		// Get Regular FS Keeper flights for pilot's stadistics
		$sql = "select count(*) flights from pirepfsfk where gvauser_id=$id and charter=0 and validated=2";
		if (!$result = $db->query($sql)) {
			die('There was an error running the query [' . $db->error . ']');
		}
		while ($row = $result->fetch_assoc()) {
		...
		// Get FS Keeper distance for pilot's stadistics
		$sql = "select sum(DistanceRoute) distance from pirepfsfk where gvauser_id=$id and validated=2";
		if (!$result = $db->query($sql)) {
			die('There was an error running the query [' . $db->error . ']');
		}
		while ($row = $result->fetch_assoc()) {
		...
		// Get FS ACARS flights for pilot's stadistics
		$sql = "select count(*) flights from reports where pilot_id=$id and validated=2";
		if (!$result = $db->query($sql)) {
			die('There was an error running the query [' . $db->error . ']');
		}
		while ($row = $result->fetch_assoc()) {
		...
		// Get Regular FS ACARS flights for pilot's stadistics
		$sql = "select count(*) flights from reports where pilot_id=$id and charter=0 and validated=2";
		if (!$result = $db->query($sql)) {
			die('There was an error running the query [' . $db->error . ']');
		}
		while ($row = $result->fetch_assoc()) {
		...
		// Get VAM ACARS flights for pilot's stadistics
		$sql = "select count(*) flights from vampireps where gvauser_id=$id and validated=2";
		if (!$result = $db->query($sql)) {
			die('There was an error running the query [' . $db->error . ']');
		}
		while ($row = $result->fetch_assoc()) {
		...
		//  Get distancer of VAM ACARS for pilot's stadistics
		$sql = "select sum(distance) distance from vampireps where gvauser_id=$id and validated=2";
		if (!$result = $db->query($sql)) {
			die('There was an error running the query [' . $db->error . ']');
		}
		while ($row = $result->fetch_assoc()) {
		...
		// Get Regular VAM ACARS flights for pilot's stadistics
		$sql = "select count(*) flights from vampireps where gvauser_id=$id and charter=0 and validated=2";
		if (!$result = $db->query($sql)) {
			die('There was an error running the query [' . $db->error . ']');
		}
		while ($row = $result->fetch_assoc()) {
		...
		// Get FS ACARS distance for pilot's stadistics
		$sql = "select sum(distance) as distance from reports where pilot_id=$id and validated=2";
		if (!$result = $db->query($sql)) {
			die('There was an error running the query [' . $db->error . ']');
		}
		while ($row = $result->fetch_assoc()) {
