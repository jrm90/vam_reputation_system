...
You will receive a new email once we have validated your application. (Make sure your email client allows mail from admin@virtualairlinesmanager.net - if you do not receive any email, please check your spam folder)');
	...
	//Reputation System
	define('REP', 'Reputation');
	define('PILOT_REP', 'Pilot reputation');
	define('ALTER_PILOT_REP', 'Change reputation');
	define('ALTER_REASON', 'Reason of reputation change');
	define('HOLIDAYS', 'Holidays');
	define('INIT_DATE','Initial date:');
	define('FIN_DATE','Final date:');
	define('SOLIC_HOLIDAYS','Request holidays');
	define('HOLIDAYS_REQUESTS','Holidays requests');
	define('DAYS_OF_HOLIDAYS','Actual days');
	define('DAYS_OF_HOLIDAYS_REQ','Requested days');
	define('STATISTICS_REP','Reputation changes');
	define('STATISTICS_REP_VAR','Reputation variation');
	define('REP_SYSTEM','Reputation System');
	define('REP_RANK_UP','Reputation needed for rank up');
	define('REP_RANK_DOWN','Reputation needed for rank down');
	define('REP_MOVE_ARCF','Reputation needed for move aircrafts');
	define('REP_REQ_DEST','Reputation needed for request destinations');
	define('REP_0_150','Reputation penalty for landing VS less than 150');
	define('REP_150_300','Reputation penalty for landing VS  between 150 and 300');
	define('REP_300_500','Reputation penalty for landing VS  between 300 and 500');
	define('REP_500','Reputation penalty for landing VS greater than 500');
	define('REP_TOUR','Reputation added for each tour');
	define('REP_DEF_FLIGHT','Reputación por defecto de cada vuelo');
	define('REP_DAYS_INACTIVATE','Days to inactivate an user without activity');
	define('REP_PERCENT_FLIGHT','Percent of value for flights in reputation');
	define('REP_PERCENT_LOGIN','Percent of value for visits in reputation');
